...
public interface FlightRepository extends JpaRepository<Flight, Integer> {
    ...
    @Query(value = "SELECT first_leg.flight_date,first_leg.flight_no,first_leg.departure_airport,first_leg.departure_time,first_leg.arrival_airport,first_leg.arrival_time,second_leg.flight_date,second_leg.flight_no,second_leg.departure_airport,second_leg.departure_time,second_leg.arrival_airport,second_leg.arrival_time, second_leg.departure_time - first_leg.arrival_time as layover_time FROM flight first_leg INNER JOIN flight second_leg on first_leg.arrival_airport = second_leg.departure_airport WHERE first_leg.departure_airport = ?1 AND second_leg.arrival_airport = ?2 AND first_leg.arrival_time < second_leg.departure_time AND second_leg.departure_time - first_leg.arrival_time between 25000 and 45000", nativeQuery = true)
